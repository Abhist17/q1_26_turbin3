...
// pubkey = 83Mw5uJvt11MYvDU1dfTtAjC3wdBhKpx5PZtmfzhJf9o

// New pubkey was generated and it was really important to run the code"
//Worked later on 83Mw5uJvt11MYvDU1dfTtAjC3wdBhKpx5PZtmfzhJf9o
mod error;
use crate::error::VaultError;


declare_id!("83Mw5uJvt11MYvDU1dfTtAjC3wdBhKpx5PZtmfzhJf9o");

#[program]
pub mod vault_solana {
    use super::*;
